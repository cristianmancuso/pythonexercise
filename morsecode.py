...
stringCodeA = "Hi this message will be change"


def morseCode(stringCode):
    allUpper = stringCodeA.upper() # change all letters to Upper
    table = str.maketrans("ABCDEFGHIJKLMNOPKRSTUVWXYZ","KEYWORDABCFGHIJLMNPQSRUVXZ") #Create the table translate
    allUpperMorse = allUpper.translate(table) #Change the letters
    print(allUpperMorse) #print the string
    
morseCode(stringCodeA)